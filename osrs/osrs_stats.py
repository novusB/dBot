...
class OSRSStats(commands.Cog):
    ...
    async def cog_load(self):
        ...
        print(f"OSRSStats cog loaded and registered - Version {self.version}")

    def cog_unload(self):
        """Called when the cog is unloaded."""
        asyncio.create_task(self.session.close())
        print(f"OSRSStats cog unloaded - Version {self.version}")
    ...
    def create_detailed_overview_embed(self, username: str, stats: dict, account_type: str = "normal") -> discord.Embed:
        ...
        embed.set_footer(text=f"Account Stage: {analysis['account_stage']} • Use .osrs skill/boss/goals for more details • v{self.version}")
        return embed
    ...
    def create_detailed_skill_embed(self, username: str, skill: str, skill_data: dict, account_type: str) -> discord.Embed:
        ...
        embed.set_footer(text=f"Skill Category: {self.get_skill_category(skill)} • v{self.version}")
        return embed
    ...
    async def osrs_boss(self, ctx, *, args: str):
        ...
        async with ctx.typing():
            ...
            embed.set_footer(text=f"Total Boss Kills: {self.format_number(total_boss_kills)} • v{self.version}")
    ...
    def get_popular_items(self) -> List[str]:
        ...
        return [
            ...
            "Iron ore", "Lobster", "Monkfish", "Anglerfish", "Saradomin brew(4)", 
            "Super restore(4)", "Stamina potion(4)", "Divine super combat potion(4)", 
            "Extended antifire(4)", "Rune platebody", "Adamant platebody", "Mithril ore"
        ]
